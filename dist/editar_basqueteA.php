					...
					<div class="card">
                        ...
                        ?>  
                            <form  action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-secondary">
                                        <input name="btnEnviar" type="submit" class="btn btn-primary px-4" value="Atualizar Dados">
                            ...
                            if(isset($_POST['btnEnviar'])){
                                ...
                                $editar = "UPDATE tb_basquete SET nome_basquete=:nome,foto_basquete=:foto,v_basquete=:v,d_basquete=:d,p_basquete=:p,pf_basquete=:pf,ps_basquete=:ps,sp_basquete=:sp WHERE id_basquete=:id";
                                $cadastro = "INSERT INTO tb_basquete (nome_basquete, foto_basquete, v_basquete, d_basquete, p_basquete, pf_basquete, ps_basquete, sp_basquete) VALUES (:nome, :foto, :v, :d, :p, :pf, :ps, :sp)";
                                try{
