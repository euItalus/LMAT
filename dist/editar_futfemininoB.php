				...
				<div class="col-lg-6">
					<div class="card">
                        ...
                        <?php
                            ...
                            $id = $_GET['idUp'];
                            $select = "SELECT * FROM tb_fut_feminino_classificacaob WHERE id_fut_feminino_classificacaoB=:id";
                            try{
                            ...
                            if($contar>0){
                                ...
                                $idTime = $show->id_fut_feminino_classificacaoB; 
                                $nomeTime = $show->nome_fut_feminino_classificacaoB;
                                $pTime = $show->p_fut_feminino_classificacaoB;
                                $jTime = $show->j_fut_feminino_classificacaoB;
                                $vTime = $show->v_fut_feminino_classificacaoB;
                                $eTime = $show->e_fut_feminino_classificacaoB;
                                $dTime = $show->d_fut_feminino_classificacaoB;
                                $gpTime = $show->gp_fut_feminino_classificacaoB;
                                $gcTime = $show->gc_fut_feminino_classificacaoB;
                                $sgTime = $show->sg_fut_feminino_classificacaoB;
                                $fotoTime = $show->foto_fut_feminino_classificacaoB;
                                }
                            }
                            ...
                            <form  action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                    if(isset($_POST['btnUp'])){
                                        ...
                                        $editar = "UPDATE tb_fut_feminino_classificacaoB SET nome_fut_feminino_classificacaoB=:nome,foto_fut_feminino_classificacaoB=:foto,p_fut_feminino_classificacaoB=:p,
                                        j_fut_feminino_classificacaoB=:j,v_fut_feminino_classificacaoB=:v,e_fut_feminino_classificacaoB=:e,d_fut_feminino_classificacaoB=:d,gp_fut_feminino_classificacaoB=:gp,
                                        gc_fut_feminino_classificacaoB=:gc,sg_fut_feminino_classificacaoB=:sg WHERE id_fut_feminino_classificacaoB=:id";
                                        $cadastro = "INSERT INTO tb_fut_feminino_classificacaoB (nome_fut_feminino_classificacaoB, foto_fut_feminino_classificacaoB, p_fut_feminino_classificacaoB, 
                                        j_fut_feminino_classificacaoB, v_fut_feminino_classificacaoB, e_fut_feminino_classificacaoB, d_fut_feminino_classificacaoB, gp_fut_feminino_classificacaoB, gc_fut_feminino_classificacaoB, 
                                        sg_fut_feminino_classificacaoB) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                        try{
