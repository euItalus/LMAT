        ...
        <div class="row justify-content-center">
          <div class="col-8">
            ...
            <div class="card-header" style="text-align: center">
                <h4 class="card-title" style="text-align: center;"> CLASSIFICAÇÃO BASQUETE</h4>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        ...
                        $select = "SELECT * FROM tb_basquete ORDER BY p_basquete DESC";
                            try{
                    ...
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="assets/images/times/<?php echo $show->foto_basquete;?>"></td>
                        <td class="text-bold-500" style="text-align: center;"><?php echo $show->nome_basquete;?></td>
                        <td><?php echo $show->v_basquete;?></td>
                        <td><?php echo $show->d_basquete;?></td>
                        <td><?php echo $show->p_basquete;?></td>
                        <td><?php echo $show->pf_basquete;?></td>
                        <td><?php echo $show->ps_basquete;?></td>
                        <td><?php echo $show->sp_basquete;?></td>
                        <td><a href="editar_basqueteA.php?idUp=<?php echo $show->id_basquete ?>;" class="badge bg-success rounded-pill">EDITAR</a> <a href="delbasquete.php?idDel=<?php echo $show->id_basquete; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_basquete; ?>?')">DELETE</a></td>
                    </tr>
                    <?php
                     }
                       }else{
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">PF</label>
                                                        <input type="text" id="d" class="form-control"
                                                            required placeholder="Pontos Feitos" name="pf">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">PS</label>
                                                        <input type="text" id="d" class="form-control"
                                                            required placeholder="Pontos Sofridos" name="ps">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="d" class="form-control"
                                                            required placeholder="Saldo de Pontos" name="sp">
                                                    </div>
                                                </div>
                                            ...
                                            if(isset($_POST['botao'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        $cadastro = "INSERT INTO tb_basquete (nome_basquete, foto_basquete, pf_basquete, v_basquete, d_basquete, p_basquete, ps_basquete, sp_basquete) VALUES (:nome, :foto, :pf, :v, :d, :p, :ps, :sp)";
                                                        try{
                                                            $result = $conect->prepare($cadastro);
                                                            $result->bindParam(':nome',$nome,PDO::PARAM_STR);
                                                            $result->bindParam(':pf',$pf,PDO::PARAM_STR);
