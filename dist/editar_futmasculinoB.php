...
<head>
    ...
    <title>LMAT - Futsal Masculino Grupo B</title>
				...
				<div class="col-lg-6">
					<div class="card">
                        ...
                        <?php
                            ...
                            $id = $_GET['idUp'];
                            $select = "SELECT * FROM tb_fut_masculino_classificacaob WHERE id_fut_masculino_classficacaoB=:id";
                            try{
                            ...
                            if($contar>0){
                                ...
                                $idTime = $show->id_fut_masculino_classficacaoB; 
                                $nomeTime = $show->nome_fut_masculino_classificacaoB;
                                $pTime = $show->p_fut_masculino_classificacaoB;
                                $jTime = $show->j_fut_masculino_classificacaoB;
                                $vTime = $show->v_fut_masculino_classificacaoB;
                                $eTime = $show->e_fut_masculino_classificacaoB;
                                $dTime = $show->d_fut_masculino_classificacaoB;
                                $gpTime = $show->gp_fut_masculino_classificacaoB;
                                $gcTime = $show->gc_fut_masculino_classificacaoB;
                                $sgTime = $show->sg_fut_masculino_classificacaoB;
                                $fotoTime = $show->foto_fut_masculino_classificacaoB;
                                }
                            }
                            ...
                            <form  action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                    if(isset($_POST['btnUp'])){
                                        ...
                                        $editar = "UPDATE tb_fut_masculino_classificacaoB SET nome_fut_masculino_classificacaoB=:nome,foto_fut_masculino_classificacaoB=:foto,p_fut_masculino_classificacaoB=:p,
                                        j_fut_masculino_classificacaoB=:j,v_fut_masculino_classificacaoB=:v,e_fut_masculino_classificacaoB=:e,d_fut_masculino_classificacaoB=:d,gp_fut_masculino_classificacaoB=:gp,
                                        gc_fut_masculino_classificacaoB=:gc,sg_fut_masculino_classificacaoB=:sg WHERE id_fut_masculino_classficacaoB=:id";
                                        $cadastro = "INSERT INTO tb_fut_masculino_classificacaoB (nome_fut_masculino_classificacaoB, foto_fut_masculino_classificacaoB, p_fut_masculino_classificacaoB, 
                                        j_fut_masculino_classificacaoB, v_fut_masculino_classificacaoB, e_fut_masculino_classificacaoB, d_fut_masculino_classificacaoB, gp_fut_masculino_classificacaoB, gc_fut_masculino_classificacaoB, sg_fut_masculino_classificacaoB) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                        try{
