                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                                <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="assets/images/times/<?php echo $show->foto_carimba;?>"></td>
                                ...
                                <td><a href="editar_carimba.php?idUp=<?php echo $show->id_carimba?>;" class="badge bg-success rounded-pill">EDITAR</a> <a href="delcarimba.php?idDel=<?php echo $show->id_carimba; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_carimba; ?>?')">DELETE</a></td>
                            </tr>
                            <?php
                            }
                            }else{
                                            ...
                                            if(isset($_POST['botao'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        $cadastro = "INSERT INTO tb_carimba (nome_carimba, foto_carimba, j_carimba, v_carimba, d_carimba, p_carimba) VALUES (:nome, :foto, :j, :v, :d, :p)";
                                                        try{
