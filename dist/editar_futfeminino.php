				...
				<div class="col-lg-6">
					<div class="card">
                        ...
                        <?php
                            ...
                            $id = $_GET['idUp'];
                            $select = "SELECT * FROM tb_fut_feminino_classificacaoa WHERE id_fut_feminino_classificacaoA=:id";
                            try{
                            ...
                            if($contar>0){
                                ...
                                $idTime = $show->id_fut_feminino_classificacaoA; 
                                $nomeTime = $show->nome_fut_feminino_classificacaoA;
                                $pTime = $show->p_fut_feminino_classificacaoA;
                                $jTime = $show->j_fut_feminino_classificacaoA;
                                $vTime = $show->v_fut_feminino_classificacaoA;
                                $eTime = $show->e_fut_feminino_classificacaoA;
                                $dTime = $show->d_fut_feminino_classificacaoA;
                                $gpTime = $show->gp_fut_feminino_classificacaoA;
                                $gcTime = $show->gc_fut_feminino_classificacaoA;
                                $sgTime = $show->sg_fut_feminino_classificacaoA;
                                $fotoTime = $show->foto_fut_feminino_classificacaoA;
                                }
                            }
                            ...
                            <form  action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                    if(isset($_POST['btnUp'])){
                                        ...
                                        $editar = "UPDATE tb_fut_feminino_classificacaoA SET nome_fut_feminino_classificacaoA=:nome,foto_fut_feminino_classificacaoA=:foto,p_fut_feminino_classificacaoA=:p,
                                        j_fut_feminino_classificacaoA=:j,v_fut_feminino_classificacaoA=:v,e_fut_feminino_classificacaoA=:e,d_fut_feminino_classificacaoA=:d,gp_fut_feminino_classificacaoA=:gp,
                                        gc_fut_feminino_classificacaoA=:gc,sg_fut_feminino_classificacaoA=:sg WHERE id_fut_feminino_classificacaoA=:id";
                                        ...
                                        j_fut_feminino_classificacaoA, v_fut_feminino_classificacaoA, e_fut_feminino_classificacaoA, d_fut_feminino_classificacaoA, gp_fut_feminino_classificacaoA, gc_fut_feminino_classificacaoA, 
                                        sg_fut_feminino_classificacaoA) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                        try{
