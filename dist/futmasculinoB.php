                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><div style="width: 55px; height:55px; border-radius:100%; background-size:100%; background-repeat:no-repeat;background-position:center;background-image:url(assets/images/times/<?php echo $show->foto_fut_masculino_classificacaoB;?>)"></div></td>
                        ...
                        <td><a href="editar_futmasculinoB.php?idUp=<?php echo $show->id_fut_masculino_classficacaoB;?>" class="badge bg-success rounded-pill">EDITAR</a> <a href="delfutmasc2.php?idDel=<?php echo $show->id_fut_masculino_classficacaoB; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_fut_masculino_classificacaoB; ?>?')">DELETE</a></td>
                    </tr>
                    <?php
                     } 
                       }else{
                        ...
                        <div class="col-7">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" style="text-align: center;">CADASTRO DE TIMES - GRUPO B</h4>
                                </div>
                                        ...
                                        <form class="form" action="" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex justify-content-end">
                                                    <button type="submit" class="btn btn-primary me-1 mb-1" name="botao2">Enviar</button>
                                            ...
                                            if(isset($_POST['botao2'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        ...
                                                        j_fut_masculino_classificacaoB, v_fut_masculino_classificacaoB, e_fut_masculino_classificacaoB, d_fut_masculino_classificacaoB, gp_fut_masculino_classificacaoB,
                                                        gc_fut_masculino_classificacaoB, sg_fut_masculino_classificacaoB) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                                        try{
