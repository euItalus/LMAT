                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="assets/images/times/<?php echo $show->foto_volei_B;?>"></td>
                        ...
                        <td><a href="editar_voleiB?idUp=<?php echo $show->id_volei_B;?>" class="badge bg-success rounded-pill">EDITAR</a> <a href="delvolei2.php?idDel=<?php echo $show->id_volei_B; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_volei_B; ?>?')">DELETE</a></td>
                    </tr>
                    <?php
                     }
                       }else{
                                            ...
                                            if(isset($_POST['botao'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        $cadastro = "INSERT INTO tb_volei_b (nome_volei_B, foto_volei_B, j_volei_B, v_volei_B, d_volei_B, p_volei_B, sp_volei_B, sc_volei_B, ds_volei_B) VALUES (:nome, :foto, :j, :v, :d, :p, :sp, :sc, :ds)";
                                                        try{
