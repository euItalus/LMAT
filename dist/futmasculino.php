                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="assets/images/times/<?php echo $show->foto_fut_masculino_classificacaoA;?>"></td>
                        ...
                        <td><a href="editar_futmasculino.php?idUp=<?php echo $show->id_fut_masculino_classficacaoA;?>" class="badge bg-success rounded-pill">EDITAR</a> <a href="delfutmasc.php?idDel=<?php echo $show->id_fut_masculino_classficacaoA; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_fut_masculino_classificacaoA; ?>?')">DELETE</a></td>
                    </tr>
                    <?php
                     }
                       }else{
                                            ...
                                            if(isset($_POST['botao'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        $cadastro = "INSERT INTO tb_fut_masculino_classificacaoa (nome_fut_masculino_classificacaoA,foto_fut_masculino_classificacaoA, p_fut_masculino_classificacaoA, j_fut_masculino_classificacaoA, v_fut_masculino_classificacaoA, e_fut_masculino_classificacaoA, d_fut_masculino_classificacaoA, gp_fut_masculino_classificacaoA, gc_fut_masculino_classificacaoA, sg_fut_masculino_classificacaoA) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                                        try{
