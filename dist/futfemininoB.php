...
<head>
    ...
    <title>LMAT - Futsal Feminino Grupo B</title>
                                ...
                                <div
                                    ...
                                    <div class="submenu-group-wrapper">
                                        <ul class="submenu-group">
                                            ...
                                            <li class="submenu-item">
                                                <a href="volei.php" class='submenu-link'>Vôlei - B</a>
                                            </li>
                                            <li class="submenu-item">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="assets/images/times/<?php echo $show->foto_fut_feminino_classificacaoB;?>"></td>
                        ...
                        <td><a href="editar_futfemininoB.php?idUp=<?php echo $show->id_fut_feminino_classificacaoB;?>" class="badge bg-success rounded-pill">EDITAR</a> <a href="delfutfem2.php?idDel=<?php echo $show->id_fut_feminino_classificacaoB; ?>" class="badge bg-danger rounded-pill" title="Remover" onclick="return confirm('Deseja remover a equipe <?php echo $show->nome_fut_feminino_classificacaoB; ?>?')">DELETE</a></td>
                    </tr>
                    <?php
                     } 
                       }else{
                                            ...
                                            if(isset($_POST['botao2'])) {
                                                ...
                                                if(in_array($extensao, $formatP)){
                                                    ...
                                                    if(move_uploaded_file($temporario, $pasta.$novoNome)){
                                                        ...
                                                        j_fut_feminino_classificacaoB, v_fut_feminino_classificacaoB, e_fut_feminino_classificacaoB, d_fut_feminino_classificacaoB, gp_fut_feminino_classificacaoB,
                                                        gc_fut_feminino_classificacaoB, sg_fut_feminino_classificacaoB) VALUES (:nome, :foto, :p, :j, :v, :e, :d, :gp, :gc, :sg)";
                                                        try{
