...
<head>
    ...
    <title>LMAT - Vôlei Grupo B</title>
				...
				<div class="col-lg-6">
					<div class="card">
                        ...
                        <?php
                            ...
                            $id = $_GET['idUp'];
                            $select = "SELECT * FROM tb_volei_b WHERE id_volei_B=:id";
                            try{
                            ...
                            if($contar>0){
                                ...
                                $idTime = $show->id_volei_B; 
                                $nomeTime = $show->nome_volei_B;
                                $pTime = $show->p_volei_B;
                                $jTime = $show->j_volei_B;
                                $vTime = $show->v_volei_B;
                                $dTime = $show->d_volei_B;
                                $spTime = $show->sp_volei_B;
                                $scTime = $show->sc_volei_B;
                                $dsTime = $show->ds_volei_B;
                                $fotoTime = $show->foto_volei_B;
                                }
                            }
                            ...
                            <form  action="" method="post" enctype="multipart/form-data">
                                ...
                                <?php
                                    if(isset($_POST['btnUp'])){
                                        ...
                                        $editar = "UPDATE tb_volei_b SET nome_volei_B=:nome,foto_volei_B=:foto,p_volei_B=:p,j_volei_B=:j,v_volei_B=:v,d_volei_B=:d,sp_volei_B=:sp,sc_volei_B=:sc,ds_volei_B=:ds WHERE id_volei_B=:id";

                                        $cadastro = "INSERT INTO tb_volei_b (nome_volei_B, foto_volei_B, p_volei_B, j_volei_B, v_volei_B, d_volei_B, sp_volei_B, sc_volei_B, ds_volei_B) VALUES (:nome, :foto, :p, :j, :v, :d, :sp, :sc, :ds)";
                                        try{
