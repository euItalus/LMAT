...
<head>
    ...
    <title>LMAT &mdash; Minha Conta </title>
                ...
                <div class="card">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" name="nome" class="form-control"
                                                        placeholder="<?php echo $nome; ?>" id="first-name-icon" value="">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="password" name="senha" class="form-control" placeholder="<?php echo $senha; ?>"
                                                        id="password-id-icon">
                                                    <div class="form-control-icon">
                                        ...
                                        <div class="col-12 justify-content-end">
                                            <input name="btnUp" type="submit" class="btn px-4" style="background-color: rgb(2, 0, 102); color: white; margin-top: 1em;" value="Salvar Alterações">
                                        </div>
                                </div>
                            </form>
                            <?php
                  ...
                  if(isset($_POST['btnUp'])){
                      ...
                      if(in_array($extensao, $formatP)){
                          $pasta = "dist/assets/images/faces/";
                      ...
                      try{
                        ...
                        if($contar > 0){
                          ...
                          <br>	
                          <button class="btn btn-success btn-block"> Usuário Editado Com Sucesso! </button>
                      </div>';
                        }else{
                          echo '<br>
                          <div class="container">
                          <button class="btn btn-block" style="background-color: rgb(212, 26, 26); color: white"> Não Foi Posssível Editar Este Usuário. </button>
                          </div>';
                        }
                      }catch(PDOException $e){
