                                ...
                                <div
                                    ...
                                    <div class="submenu-group-wrapper">
                                        ...
                                        <ul class="submenu-group">
                                            ...
                                            <li class="submenu-item">
                                                <a href="dist/carimba.php" class='submenu-link'>Carimba</a>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="dist/basquete.php" class='submenu-link'>Basquete</a>
                                            </li>
      ...
      <div class="container-fluid ">
        <div class="row justify-content-center">
          <div class="col-8">
            ...
            <div class="card">
            <div class="card-header" style="text-align: center">
                <h4 class="card-title" style="text-align: center;"> CLASSIFICAÇÃO CARIMBA</h4>
            </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <table id="example7" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                include_once('config/conexao.php');
                                $select = "SELECT * FROM tb_carimba ORDER BY p_carimba DESC";
                                    try{
                                        $resultado = $conect->prepare($select);
                                        $resultado->execute();
                                        $contar = $resultado->rowCount();
                            ...
                            ?>
                            <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                                <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="dist/assets/images/times/<?php echo $show->foto_carimba;?>"></td>
                                <td class="text-bold-500" style="text-align: center;"><?php echo $show->nome_carimba;?></td>
                                <td><?php echo $show->v_carimba;?></td>
                                <td><?php echo $show->d_carimba;?></td>
                                <td><?php echo $show->p_carimba;?></td>
                                <td><?php echo $show->j_carimba;?></td>
                            </tr>
                            <?php
                            }
                            }else{
              ...
              <div class="card-body">
                <table id="example8" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr data-bs-toggle="modal" data-bs-target="#default" style="text-align: center;">
                        <td style="text-align:center"><img style="width: 55px; border-radius:100%" src="dist/assets/images/times/<?php echo $show->foto_basquete;?>"></td>
